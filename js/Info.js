let sunrise = function(actual) {
    ...
    this.display = function() {
        document.getElementById('').innerHTML = '
           Sonnenaufgang: <strong>' + displaySunRise() + '</strong> -
           Sonnenuntergang: <strong>' + displaySunDown() + '</strong> -
           Tagesdauer: <strong>' + displayDayDuration() + '</strong>';
    }
}
let cite = {};
cite.list=[];
...
cite.show = function() {
    ...
    let randomSelect = Math.floor(rand * this.list.length);
    let randomCite = this.list[randomSelect];
    return randomCite;
}