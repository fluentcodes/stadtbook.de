...
const ANCHOR_STATUS_MAP = {
              ...
              "Mode":{"id":true},
              "Musik":{"id":true},
              "Musikkonzert":{"id":true},
              "Musik Klassik":{"id":true},
...
this.getInteractive = function(type) {
    ...
    eventElement.addEventListener("mouseleave", function(event) {
        ...
        stadtbook.anchors.showEnter(key);
    },500);
...
let latestType = this.statusMap['Empfehlung'];
